...
<aside class="fixed-sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        <?php if ($role === 'admin'): ?>
            ...
            <a href="manage_applications.php" class="sidebar-link <?= $current_page === 'manage_applications.php' ? 'active' : '' ?>">
            ...
            <a href="manage_users.php" class="sidebar-link <?= $current_page === 'manage_users.php' ? 'active' : '' ?>">
        ...
        <?php else: ?>
            ...
            <a href="apply.php" class="sidebar-link <?= $current_page === 'apply.php' ? 'active' : '' ?>">
